import Abiasa2 from "../assets/Abiasa_gray.png";
...
const Footer = () => {
  return (
    <div className="flex flex-col items-center w-[16rem] ml-auto">
      <img className="w-16 h-16" src={Abiasa2} alt="abiasa_gray.png" />
